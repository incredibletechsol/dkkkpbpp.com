			...
			if(isset($_GET['msg']))

				{
					...
					if($param=="succalumini")
					 ...
					 echo "<script>createCustomAlert('Thank You for Registering with Us..','','SUCCESS');</script>";
