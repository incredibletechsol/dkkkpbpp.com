						   ...
						   <tr>
							...
							<tr>
								...
								<select class="form-control" name="deptname1">
										<?php
											$deptOptions  = array('Mechanical Engineering','Electronics and Telecommunication','Civil Engineering','Electrical Engineering','Automobile Engineering','General Science and Humanities','Others');
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										...
										while($basic_profile_row = mysqli_fetch_array($basic_profile_rs)) 
											...
											echo "<td align='center'><img src='$target_path/$basic_profile_row[7]' width='100' height='100'></td>";
					   ...
					   <tr>
						...
						<tr>
							...
							<select class="form-control" name="deptname">
								<option id="Mechanical" value="Mechanical Engineering">Mechanical Engineering</option>
								<option id="Electronics and Telecommunication" value="Electronics and Telecommunication">Electronics and Telecommunication</option>
								...
								<option id="Automobile Engineering" value="Automobile Engineering">Automobile Engineering</option>
								<option id="General Science and Humanities" value="General Science and Humanities">General Science and Humanities</option>
