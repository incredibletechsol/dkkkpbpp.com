                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
	    					 ...
	    					 <a href="admissions/firstyearnotconfirmed.xls" class="btn btn-primary btn-lg">Export To XLS</a>
							</div>
                        </div>
						
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="firstyear_unconfirmed">
                                    <thead>
                                        <tr>
                                            <th>Candidate Id</th>
					                        <th>Name</th>
                                    ...
                                    <tbody>
										<?php
										include('conn.php');
										$fetch_basic_profile="select * from tbl_admissions where status='R' and admissionTo in('fymech') order by candidate_id desc";	
                   ...
                   <!-- First Year Un Confirmed End -->
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
							 ...
							 <a href="admissions/firstyearconfirmed.xls" class="btn btn-primary btn-lg">Export To XLS</a>
							</div>
                        </div>
						
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="firstyear_confirmed">
                                    <thead>
                                        <tr>
                                            <th>Candidate Id</th>
					                        <th>Name</th>
                                    ...
                                    <tbody>
										<?php
										include('conn.php');
										$fetch_basic_profile="select * from tbl_admissions where status='C' and admissionTo in('fymech') order by candidate_id desc";	
