...
<nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
	...
	<div style="color: white;padding: 15px 50px 5px 50px;float: center;font-size: 30px;"> Late Babasaheb Phadtare Polytechnic College&nbsp;</div>
</nav>   
<nav class="navbar-default navbar-side" role="navigation">
	<div class="sidebar-collapse">
		<ul class="nav" id="main-menu">
			...
			<!--
		    <li><a href="#"><i class="fa fa-sitemap fa-3x"></i>Admissions<span class="fa arrow"></span></a>
				<ul class="nav nav-second-level">
					<li><a href="firstyear.php">First Year Admissions</a></li>
					<li><a href="secondyear.php">Direct Second  Year Admissions</a></li>
				</ul>
			</li>
			-->
			<?php
