	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "save")
				...
				if(move_uploaded_file($_FILES['doc']['tmp_name'],$target_path))
					...
					mysqli_query($conn,$document_insert) or die(mysqli_error($conn));
				
					$log->info("Document Data inserted");
					
					$message="DKKKPBPP.COM :: 1 Document Inserted";
             		}
				?>
	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "delete")
				...
				$existing_document_rs= mysqli_query($conn,$fetch_existing_document_query) or die(mysqli_error($conn));
				...
				mysqli_query($conn,$document_delete) or die(mysqli_error($conn));
				$log->info("Document Data Deleted");
				$message="DKKKPBPP.COM :: 1 Document Deleted";
				?>
