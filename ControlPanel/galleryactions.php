	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "save")
				...
				if(move_uploaded_file($_FILES['photo']['tmp_name'],$target_path))
					...
					$message="DKKKPBPP.COM :: 1 Photo Inserted";
					}
				?>
	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "delete")
				...
				$existing_photo_rs= mysql_query($fetch_existing_photo_query);
				
				while($exiting_photo_row = mysql_fetch_array($existing_photo_rs)) 
			     {
					$target_path="../gallery/";
				...
				mysqli_query($conn,$gallery_delete) or die(mysql_error());
				$log->info("Gallery  Data Deleted");
				$message="DKKKPBPP.COM :: 1 Photo Deleted";
				?>
